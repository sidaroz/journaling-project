const postData = [
  {
    id: 1,
    title: "Is a Cashew a nut or seed?",
    description:
    ...
    date: "Mon, 08 Mar 2021 12:09:56 GMT",
    reaction: [{ reaction1: 0}, {reaction2: 0}, {reaction3: 0 }],
    comment: ["Sidar you should panic"],

  },
  {
    id: 2,
    title: "What percentage of the earth's water is frozen?",
    description:
    ...
    date: "Sun, 25 Apr 2021 21:10:08 GMT",
    reaction: [{ reaction1: 3}, {reaction2: 1}, {reaction3: 0 }],
    comment: ["Luiz why are you panicking"],
  ...
  },
  {
    ...
    date: "Tue, 27 Apr 2021 03:08:51 GMT",
    reaction: [{ reaction1: 6}, {reaction2: 4}, {reaction3: 0 }],
    comment: ["Fish never sleep 🐟", "><>"],

  },
  {
    id: 4,
    title: "Who was the first person to say hello?",
    description:
    ...
    date: "Wed, 07 Jul 2021 10:19:27 GMT",
    reaction: [{ reaction1: 10}, {reaction2: 4}, {reaction3: 2 }],
    comment: ["👋", "🌊"],

  },
  {
    id: 5,
    title: "Why do you hear the ocean in a shell?",
    description:
    ...
    reaction: [{ reaction1: 1}, {reaction2: 9}, {reaction3: 1 }],
    comment: ["🐚", "👻", "Whats a shell??"],

  },
  {
    id: 6,
    title: "When is the next time the planets will align?",
    description:
    ...
    date: "Mon, 10 Jan 2022 19:30:51 GMT",
    reaction: [{ reaction1: 8}, {reaction2: 1}, {reaction3: 5 }],
    comment: ["Hubble just spotted something huge coming out of Uranus", "SIUUUUU"],

  },
  {
    id: 7,
    title: "Who came up with manga?",
    description:
    ...
    date: "Thu, 24 Mar 2022 17:59:51 GMT",
    reaction: [{ reaction1: 100}, {reaction2: 0}, {reaction3: 0}],
    comment: ["Chainsaw Man Diff", "📖🖊"],
